...
#     report_type: Any = Query(..., description="Report type"), # Changed from ReportType
...
# @router.get("/{project_id}/reports", response_model=List[Any]) # Changed from AnalyticsReportRead
# async def get_project_reports(
#     project_id: int,
#     report_type: Optional[Any] = None, # Changed from ReportType
...
# @router.get("/{project_id}/reports/{report_id}", response_model=Any) # Changed from AnalyticsReportRead
...
# @router.put("/{project_id}/reports/{report_id}", response_model=Any) # Changed from AnalyticsReportRead
...
# @router.put("/{project_id}/reports/{report_id}/publish", response_model=Any) # Changed from AnalyticsReportRead
