...
from src.models.customer_service import TicketStatus, Priority, StepStatus, PricingModel, DocumentType
...
class ServiceStepUpdate(BaseModel):
    ...
    base_price: Optional[condecimal(max_digits=10, decimal_places=2)] = Field(None, ge=0)
...
class TicketStepUpdate(BaseModel):
    ...
    unit_price: Optional[condecimal(max_digits=10, decimal_places=2)] = Field(None, ge=0)
