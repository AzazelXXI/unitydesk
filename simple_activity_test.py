    ...
    try:
        ...
        for i, activity_data in enumerate(test_activities):
            try:
                ...
                print(f"✅ Inserted activity {i+1}: {activity_data['activity_type']} (ID: {activity_id})")
        ...
        print("3. If activities still don't appear, check the browser console for errors")
